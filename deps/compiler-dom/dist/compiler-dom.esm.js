...
asRawStatements = false) {
    ...
    try {
        ...
        context.onError(createCompilerError(49 /* X_INVALID_EXPRESSION */, node.loc));
        return node;
    }
    const ids = [];
