...
export interface EventListenerProp<Events extends Record<string, any> = {}> {
  on?: {
...
export function defineComponent<Props, Events = void, RawBindings = object>(
  setup: (
  ...
  new (): ComponentPublicInstance<
    ...
    {},
    // public props
    VNodeProps & Props & EventListenerProp<Events>
  >
}
