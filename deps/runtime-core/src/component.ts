...
export type TypedEmit<Events extends Record<string, any> = {}> = UnionToIntersection<{
...
export type Emit<Events = void> = Events extends object ? TypedEmit<Events> : (event: string, ...args: unknown[]) => any[]

export interface SetupContext<Events = void> {
  attrs: Data
  slots: Slots
  emit: Emit<Events>
}
