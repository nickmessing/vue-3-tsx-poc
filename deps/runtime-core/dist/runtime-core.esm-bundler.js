...
export { isReactive, isReadonly, isRef, markNonReactive, markReadonly, reactive, readonly, ref, shallowReactive, toRaw, toRefs } from '@vue/reactivity';
...
function createRenderer(options) {
    ...
    function processPortal(n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, optimized) {
        ...
        if (n1 == null) {
            if ((process.env.NODE_ENV !== 'production') && isString(targetSelector) && !hostQuerySelector) {
...
export { BaseTransition, Comment, Fragment, KeepAlive, PatchFlags, Portal, PublicShapeFlags as ShapeFlags, Suspense, Text, callWithAsyncErrorHandling, callWithErrorHandling, camelize$1 as camelize, cloneVNode, computed, createBlock, createCommentVNode, createHook, createRenderer, createSlots, createStaticVNode, createTextVNode, createVNode, defineComponent, getCurrentInstance, h, handleError, inject, injectHook, instanceWatch, mergeProps, nextTick, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onUnmounted, onUpdated, openBlock, popScopeId, provide, pushScopeId, recordEffect, registerRuntimeCompiler, renderList, renderSlot, resolveComponent, resolveDirective, resolveDynamicComponent, resolveTransitionHooks, setBlockTracking, setTransitionHooks, ssrUtils, toDisplayString$1 as toDisplayString, toHandlers, useCSSModule, useTransitionState, version, warn, watch, withDirectives, withScopeId };
